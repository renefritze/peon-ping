...
| **JetBrains IDEs** | Plugin (preview) | Run `./build-jetbrains-plugin.sh`, then install zip from `adapters/jetbrains/build/distributions/` ([details](adapters/jetbrains/README.md)) |
